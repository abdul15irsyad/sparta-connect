...
@section('content')
    <div class="content-wrapper admins-create">
                    ...
                    <div class="card">
                        <div class="card-body row">
                            <div class="form-group col-lg-6 col-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                        name="name" placeholder="eg: John Doe" value="{{ old('name') }}">
                                    @error('name')
                            ...
                            <div class="form-group col-lg-6 col-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" id="email"
                                        name="email" placeholder="eg: example@email.com" value="{{ old('email') }}">
                                    @error('email')
                                        <span class="invalid-feedback pl-2" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group col-lg-6 col-12">
                                <label for="password" class="d-block">
                                    ...
                                    <i class="fas fa fw fa-info-circle text-sm text-info" data-toggle="tooltip"
                                        data-placement="top"
                                        title="Minimum 8 characters and must contain lowercase (a-z), uppercase (A-Z), and numbers (0-9)"></i>
                                </label>
                        ...
                        <div class="card-footer">
                            <div class="row justify-content-end">
                                <div class="col-auto">
                                    <a href="{{ route('admin.admins.index') }}" class="btn btn-transparent">Cancel</a>
                                </div>
                                <div class="col-auto">
